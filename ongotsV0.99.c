...
void DrawBoard(char data1[SIZE][SIZE], char data2[SIZE][SIZE])
{
    ...
    //         else if ( iX == 25)
    //             if (iY < 9) printf(" %d| %c |", iY+1, data2[iY][iX]);
    //             else printf("%d| %c |", iY+1, data2[iY][iX-25]);
    //         else if (iX > 19 && iX < 25) printf("    ");
    //         else if (iX < 20) printf(" %c |", data1[iY][iX]);
    //         else if (iX > 24) printf(" %c |", data2[iY][iX-25]);
    //     }
    // }
    for (iY = 0; iY < 20; iY++)
    {
        for (iX = 0; iX < 45; iX++)
        {
            ...
            {
                if (iY < 9)
                    printf(" %d| %c |", iY + 1, data2[iY][iX-25]);
                else
                    printf("%d| %c |", iY + 1, data2[iY][iX-25]);
            }
            else if (iX > 0 && iX < 20)
...
char fire(int x, int y, char myBoard[SIZE][SIZE], char enemyBoard[SIZE][SIZE])
{
    //x = x-1; y = y-1;
